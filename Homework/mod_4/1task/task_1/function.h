...
void EditArrayInt(std::vector<int>& arr, int index, int newValue);
...
void EditArrayChar(std::vector<char>& arr, int index, char newValue);
...
void EditArrayDouble(std::vector<double>& arr, int index, double newValue);
